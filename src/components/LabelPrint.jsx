        ...
        <div className="flex-1 overflow-auto bg-gray-100 p-4 flex justify-center">
          ...
          >
            ...
            <div className="w-full grid grid-cols-2 gap-y-1 text-left px-1 flex-1 content-center">
              ...
              <div>
                <span className="text-[10px] uppercase font-bold text-gray-500 block">Size (in)</span>
                <span className="font-bold text-lg leading-none">{data.width_inches}"</span>
              </div>
              <div className="text-right">
                <span className="text-[10px] uppercase font-bold text-gray-500 block">Length</span>
              ...
              <div className="col-span-2 text-center mt-1">
                ...
                <span className="font-bold text-2xl leading-none">{data.gsm}</span>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col items-center overflow-hidden pb-6">
              ...
              {showDate && (
                <div className="text-[8px] text-gray-500 mt-1 leading-none">
