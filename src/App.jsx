...
import { 
  ...
  Pencil, Trash2, X, Camera, Smartphone, Activity, Eye, FileText, CheckCircle, AlignLeft
} from 'lucide-react';
import { supabase } from './supabaseClient';

// --- GLOBAL UTILS ---
// Safely parse JSON to prevent app crashes from bad local storage data
const safeJSONParse = (key, fallback) => {
  try {
    ...
    console.warn('Storage corrupted, resetting key:', key);
...
// --- LABEL PRINT COMPONENT (V6 Key) ---
const LabelPrint = ({ data, onClose }) => {
  const savedDesign = safeJSONParse('ksf_label_design_v6', {});
  const savedLabels = safeJSONParse('ksf_label_labels_v6', {});
  ...
  useEffect(() => {
      ...
      localStorage.setItem('ksf_label_design_v6', JSON.stringify(designSettings));
      localStorage.setItem('ksf_label_labels_v6', JSON.stringify(labelSettings));
