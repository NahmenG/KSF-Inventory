...
// This function ensures the app never crashes due to bad local storage data
const safeJSONParse = (key, fallback) => {
  try {
    const item = localStorage.getItem(key);
    // If item is "undefined" string or null, return fallback
