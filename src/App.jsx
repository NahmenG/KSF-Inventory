...
export default function App() {
  ...
  const runGhostRollFix = async () => {
    // Definitive list of 634 Roll IDs that moved from History back to Stock
    ...
    if (!confirm(`Emergency: Move ${ghostIds.length} identified rolls to History?`)) return;
    ...
    try {
      ...
      alert("Success! Stock corrected. Page will refresh.");
